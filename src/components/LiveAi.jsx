    ...
    <div className='relative z-50  '>
        ...
        <Container className="py-[60px] ">
            ...
            <div className="lg:flex items-center pt-[60px] ">
                <div className="lg:w-[787px] bg-[#fff] lg:rounded-[12px] lg:mx-0 mx-[10px] rounded-[5px] ">
                    ...
                    <div className="bg-[#F2F3F3] pt-[24px] lg:pb-[273px] pb-[200px] lg:pl-[19.81px] pl-[10px] border-t-[1px] border-t-[#9a9a9a5e]">
                    ...
                    <div className="lg:flex  gap-x-[10px] lg:pl-[31px] pl-[20px] pt-[16px] ">
                        <div className="">
                ...
                <div className="lg:w-[72px]  h-[72px] lg:h-[328px] bg-[#fff] lg:my-0 my-[30px] rounded-[57px] flex items-center justify-center lg:ml-[24px] lg:mx-0 mx-[10px]">
                   ...
                   <div className="cursor-pointer active:scale-90 transition-transform duration-150">
                    <RefreshCcw />
                    </div>
                    <div className="lg:py-[40px] lg:px-0 px-[40px] cursor-pointer active:scale-90 transition-transform duration-150">
                    <ThumbsUp />
                    </div>
                    <div className="cursor-pointer active:scale-90 transition-transform duration-150">
                        <ThumbsDown /> 
                ...
                <span className="text-[12px] font-normal text-[#6D6D6D] font-inter">60%</span>
                        ...
                        <div className="h-[100px] lg:w-[475px] bg-[#FFFFFF] border-[1px] border-[#E7E7E7] rounded-[10px] mt-[20px]  ">
                    ...
                    <div className="lg:w-[535px] lg:h-[220px] h-[340px] bg-[#EFEFEF]  rounded-[20px]">
                            ...
                            <h3 className='text-[32px] text-[#323232] font-manrope font-bold h-[44px]'>Quick Actions</h3>
                            <div className="lg:flex gap-x-[20px] pt-[20px] ">
                                <div className="h-[96px] w-[227px] bg-[#FFFFFF] border-[1px] border-[#E7E7E7] rounded-[8px]">
                                ...
                                <div className="h-[96px] w-[227px] bg-[#FFFFFF] border-[1px] border-[#E7E7E7] rounded-[8px] lg:mt-0 mt-[20px]">
                                   <div className="pt-[16px] pl-[16px]">
