...
const Courses = () => {
    return (
        <div className='pt-[84px] relative z-50 lg:mx-0 mx-[10px]'>
            <Container>
                ...
                <div className="lg:flex justify-between pt-[48px] ">
                    ...
                    <div className="bg-[#F0F0F0] rounded-[15px] lg:w-[705px] lg:h-[809px] ">
                        <div className="lg:w-[605px] lg:mx-auto mx-[25px] lg:py-[50px] py-[30px]">
                        <div className="">
                        <img src={robo3} alt="" />
                        </div>
                        <div className="flex pt-[39px] justify-between ">
                            ...
                            <div className="">
                                <p className='lg:text-[20px] font-manrope font-medium text-[#262626]'>By John Smith</p>
                            </div>
                        </div>
                        <div className=" pt-[30px]">
                            ...
                            <p className='text-[18px] lg:text-start text-center text-[#4C4C4D] font-manrope font-normal leaing-[1505] pt-[14px]'>Learn the fundamentals of web design, including HTML, CSS, and responsive design principles. Develop the skills to create visually appealing and user-friendly websites.</p>
                        </div>
                        <div className="pt-[40px]">
                            <a className='text-[18px] text-[#fff] font-manrope font-medium py-[18px] lg:px-[255.9px] px-[110px]  bg-[#002868] rounded-[8px]' href="#">Get it Now</a>
                        </div>
                        </div>
                    </div>
                    </div>
                    ...
                    <div className="bg-[#F0F0F0] rounded-[15px] lg:w-[705px] lg:h-[809px] ">
                        ...
                        <div className="flex pt-[39px] justify-between">
                            <div className="flex gap-x-[10px]">
                                <div className="py-[10px] px-[16px] bg-[#fff] rounded-[6px]" >
                                    <span className='lg:text-[18px] text-[#4C4C4D] leading-auto font-manrope font-medium '>4 Weeks</span>
                                </div>
                                <div className="py-[10px] px-[16px] bg-[#fff] rounded-[6px]" >
                                    <span className='lg:text-[18px] text-[#4C4C4D] leading-auto font-manrope font-medium'>Beginner</span>
                                </div>
                            </div>
                            <div className="">
                                <p className='lg:text-[20px] font-manrope font-medium text-[#262626]'>By John Smith</p>
