...
const Faq = () => {
  ...
  return (
    <div className='lg:pt-[164px] pt-[60px] pb-[101px] relative z-50 overflow-hidden lg:mx-0 mx-[20px] '>
        <div className="absolute top-[-280px] left-0 transformX-[-50%] -z-50 " >
            <img src={shadow2} alt="" />
        </div>
      <Container>
    ...
    className={` transition-transform duration-500 ${
      activeIndex === index ? "rotate-[360deg]" : "rotate-0"
    }`}
  >
